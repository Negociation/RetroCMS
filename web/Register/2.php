...
<title><?php echo $this->hotel->get_HotelName();?> ~ <?php echo $this->title ?> ~ Tell us your birthday</title>


<?php include './Web/Includes/Content/Sources/Sources.php'; ?>
...
<div id="process-wrapper">
	<div id="process-header"><div id="process-header-body"><div id="process-header-content">
		...
		<div id="steps">
<img src="<?php echo $this->hotel->get_HotelURL() ?>/habboweb/16/11/web-gallery/images/process/step1.gif" alt="1" width="30" height="26"><img src="<?php echo $this->hotel->get_HotelURL() ?>/habboweb/16/11/web-gallery/images/process/step_right.gif"><img src="<?php echo $this->hotel->get_HotelURL() ?>/habboweb/16/11/web-gallery/images/process/step2_on.gif" alt="2" width="30" height="26"><img src="<?php echo $this->hotel->get_HotelURL() ?>/habboweb/16/11/web-gallery/images/process/step_right_on.gif" alt="" width="20" height="26"><img src="<?php echo $this->hotel->get_HotelURL() ?>/habboweb/16/11/web-gallery/images/process/step3.gif" alt="3" width="30" height="26"><img src="<?php echo $this->hotel->get_HotelURL() ?>/habboweb/16/11/web-gallery/images/process/step_right.gif" alt="" width="20" height="26"><img src="<?php echo $this->hotel->get_HotelURL() ?>/habboweb/16/11/web-gallery/images/process/step4.gif" alt="4" width="30" height="26"><img src="<?php echo $this->hotel->get_HotelURL() ?>/habboweb/16/11/web-gallery/images/process/step_right.gif" alt="" width="20" height="26"><img src="<?php echo $this->hotel->get_HotelURL() ?>/habboweb/16/11/web-gallery/images/process/step5.gif" alt="5" width="30" height="26">
</div>
	</div></div></div>
...
<div id="footer">
	<div id="footer-top"><div id="footer-content">phelpsy</div></div>
