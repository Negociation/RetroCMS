...
?>
			...
			<script language="JavaScript" type="text/javascript" src="<?php echo $this->hotel->get_HotelWeb(); ?>/habboweb/16/11/web-gallery/js/hobojax.js"></script>
			<script language="JavaScript" type="text/javascript" src="<?php echo $this->hotel->get_HotelWeb(); ?>/habboweb/16/11/web-gallery/js/validation.js"></script>
...
switch (get_class($this)){
	...
	case "Groups":
		...
		break;
	case "Register":
		echo '			<script language="JavaScript" type="text/javascript" src="'.$this->hotel->get_HotelWeb().'/habboweb/16/11/web-gallery/js/registration.js"></script>';
		break;
	case "Client":
