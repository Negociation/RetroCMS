...
final class Install{
	...
	private static function start(){	
		...
		self::$hotelData = parse_ini_file(dirname(__DIR__, 2).'\install\retrosys\settings.ini', true);
		self::$testsStatus[1] = !empty(self::$hotelData) ? true : false;

		// TEST IF COMPOSER HAVE BE STARTED
		self::$testsStatus[2] = stream_resolve_include_path(dirname(__DIR__, 2)."/install/vendor/autoload.php") ? true : false;
