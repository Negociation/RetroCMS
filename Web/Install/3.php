...
<div class="processbox">
	...
	<div class="content-top">
		<div class="content">
			...
			<div class="frank"><img src="<?php echo $this->hotel->get_HotelURL() ?>/habboweb/16/11/web-gallery/images/install/3.gif" alt="" width="245" height="191"></div>
		</div>
							...
							<div class="content-white-content">                                                
								<form method="post" action="<?php echo $this->hotel->get_HotelURL() ?>/install/done" id="stepform">                                                    
									...
									<div align="right">
												...
												<input type="hidden" name="required-hotelVars" value="<?php echo $this->newHotel->get_HotelVariables() ?>" />
												<input type="hidden" name="required-hotelTexts" value="<?php echo $this->newHotel->get_HotelTexts() ?>" />
												<input type="hidden" name="required-hotelDcr" value="<?php echo $this->newHotel->get_HotelDcr() ?>" />
												<input type="hidden" name="required-hotelVersion" value="<?php echo $this->newHotel->get_HotelVersion() ?>" />
												<input type="hidden" name="required-hotelHost" value="<?php echo $this->newHotel->get_HotelHost() ?>" />
												<input type="hidden" name="required-hotelPort" value="<?php echo $this->newHotel->get_HotelPort() ?>" />
												<input type="hidden" name="required-hotelMusHost" value="<?php echo $this->newHotel->get_HotelMusHost() ?>" />
												<input type="hidden" name="required-hotelMusPort" value="<?php echo $this->newHotel->get_HotelMusPort() ?>" />
