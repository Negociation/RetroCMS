...
--
-- Estrutura da tabela `public_items`
--

CREATE TABLE `public_items` (
  `id` int(11) NOT NULL,
  `room_model` varchar(255) CHARACTER SET utf8 NOT NULL,
  `sprite` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `behaviour` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `current_program` varchar(255) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;

--
-- Extraindo dados da tabela `public_items`
--
